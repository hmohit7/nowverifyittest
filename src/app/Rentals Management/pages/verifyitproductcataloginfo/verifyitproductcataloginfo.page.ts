...
export class VerifyitProductCatalogInfoPage {
  ...
  constructor(
    ...
    if(this.callgettagresult.meta_data){

      // this.callgettagresult= this.callgettagresult
      Object.keys(this.callgettagresult.meta_data).forEach(e=> this.jsonToBeUsed.push({key:e , value: this.callgettagresult.meta_data[e]}))
    }else{
